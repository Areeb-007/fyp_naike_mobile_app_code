...
class DesignConfig {
  ...
  static Widget setButtonUI(String title, bool isrighticon) {
    return new Container(
        ...
        decoration: DesignConfig.circulargradientBtn,
        child: isrighticon
            ? Row(children: <Widget>[
                Expanded(
                  child: Text(
  ...
  static BoxDecoration circulargradientBtn = BoxDecoration(
  ...
  static BoxDecoration circulargradientBox = BoxDecoration(
    gradient: gradient,
    borderRadius: BorderRadius.circular(10),
    boxShadow: [
      boxShadow,
