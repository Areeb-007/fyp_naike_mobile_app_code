class StringsRes {
  static String mainappname = "Naik-E";

  static String appname = "Naik-E";
  static String refertext = "I'm inviting you to be a part of Naik-E";
  static String shareText =
      "Hi there do you trade bitcoin? There is an app that pays you automatically with very high rate here is the app";
  ...
  static String intro3 =
      "Never pay for wallet fees\nnever again when you sell your Paxful bitcoin";
  static String intro4 =
      "It is a fully automated cryptocurrences trading \nplatform in Nigeria";
  ...
  static String raiseNeed = "Raise \nNeeds";
  static String raiseDonation = "Raise Donations";
  static String history = "History";
  static String ratecalc = "Rate Calculator";
  static String withdraw = "Withdraw";
  static String lblCopied = "Copied";
  ...
  static String coinbuyinfo =
      "Enter your wallet address above. Please check that the wallet address you entered is correct, as we will not be responsible for funding wrong wallet address .";
  static String minsellinfo =
      "is the minimum trade amount accepted. The bank account on your profile will be credited automatically!";
  static String minbuyinfo = "is the minimum purchase allowed.";
  static String bankinfowarning =
      "Please fill Bank Details from Profile to Withdraw";
  ...
  static String iAccept = "By continuing you agree to our\t";
  static String pending = "Pending";
  static String kycpending = "KYC is Pending";
  static String qrdetailinfo =
      "Please make your payment to your unique trade address below, we will automatically detect how much you sent and credit your bank!.";
  ...
  static String buyconfirminfo =
      "Coins will be automatically sent to you instantly after your payment is successfully confirmed.";
  ...
  static String topupinfo =
      "To TOP-UP your banking balance please deposit or transfer funds into the following bank account. Upon successful deposit into your account we will credit your banking wallet instantly.";
  ...
  static String kycverificationnote =
      "Please note that KYC verification is only for users who also want to buy coins or create an instantcoins bank account, if you just want to sell coins you do not need to complete any KYC process!";
  static String variouslevel = "Various KYC Levels and its benefits";
  static String docinfotitle =
      "In order to complete your KYC verification, you will need the below documents:";
  static String personaldetails = "Personal Details";
  static String level1bankinfo =
      "To comply with financial regulations, we require every user that wishes to buy coins or create a bank account from us to complete our KYC process.";
  static String level1infowarning =
      "Please enter your correct information as it appears in your bank, as we will be checking this with your bank automatically to confirm if it is correct. Your can’t edit these details once you have submitted the form.";
  ...
  static String enterDob = "Enter Date of Birth";
  ...
  static String enterValidContact = "Enter Valid Contact Number";
  ...
  static String lblDate = "Date";
  static String lblAND = "&";
  ...
  static String bvnverificationnote =
      "We do not have access to any of your banking information, we only use your BVN to confirm that the first and last name you provided is correct and you are who you say you are, this is to prevent fraudulent users.";
  static String kyclevel3info =
      "To Complete Level 3 KYC,  Complete level 1 & 2 and then upload selfie with the ID Card and written paper to enter level 3. Verification will be approved by Instancecoins Team.";
  static String kyclevel2info =
      "To verify your identity, please upload any of your documents. Complete Level 1 and then upload national ID card and utility bill for Level 2 KYC. Verification will be approved by Instantcoins Team";
  static String uploaddocinfo =
      "In order to begin, please upload any of the following personal document.";
  ...
  static String avoiddeleyinfotitle =
      "To avoid possible delays when verifying your account, Please make sure of the below:";
  static String contactverificaiton = "Contact Verification";
  static String verifyyourno = "Verify your Number.";
  static String mobilenoconfirm =
      "We will send a one time code to the phone number below:";
  static String otpinfo =
  ...
  static String transferbankamtinfo =
      "With your banking balance, you can send and recieve money from any bank in Nigeria. Please fill in the below form to transfer funds instantly. Please fill all the details correctly.";
  static String nobankactitle =
      "Do you know you can open a bank account instantly without any paper work or walking into the bank ?";
  static String logoutconfirm =
  ...
  static String sendmemarketingemail =
      "Send me Marketing and Transaction email";
  static String receiveactivationmailmsg =
      "You will Receive an Activation Email in your Inbox";
  ...
  static String enterTransactionpin = 'Enter Transaction Pin';
  ...
  static String lblTypeYourMessage = "Type Your Message";
  ...
  static String transactionpinmsg =
      "Transaction Pin is used to secure your Bank Account Changes , Banking Transfers and Withdrawal Requests.Use Numbers,Characters and Special Characters and Never Share your Transaction Pin with anyone.";
  ...
  static String pubpaypagestatuswarning =
      "If you deactivate this then no one will be able to see your Public Payment Page";
  static String notificationSales =
      "Notify me by email about resumption of sales.";
  static String notificationNews = "Notify me by email for latest news.";
  static String notificationUnusalactivity =
      "Alert me by email for unusual activity.";
  static String aboutme = "About Me";
  static String lblbank = "Bank";
  static String bankenablemsg =
      "Complete KYC Level 1 to enable Bank Transfer in Public Payment Page.";
  static const String apiKeyForMaps = 'AIzaSyDXS5lJXM8INgkGtpmM-fiLlmaveWMrF_Y';
  static const String userIdInSharedPrefs = 'userID';
  static const String tokenInSharedPrefs = 'userToken';
}
